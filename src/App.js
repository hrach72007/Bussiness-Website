...
<div className='top-0 left-0 relative'>
    <img src={headerimg} className='relative top-0 left-0' alt='/'/>
<img src={logo} className='absolute top-[15%] left-[10%]' alt='/'/>
<img src={footerimg} className='absolute top-0 left-[50%] w-[50%]' alt='/'/>
<img src={slider} className='absolute slider top-[60%] left-[60%] w-[40%] ' alt='/'/>
<LanguageSwitcher/>
...
<div className='slide-in-from-bottom absolute text-gray bottom-[10%] left-[10%] font-sans font-medium text-6xl space-y-4'>
<h2>{t('header.text')}</h2>
<h2>{t('header.text_')} <span className='underline'> {t('header.text2_')}</span></h2>
<h2 className=''>{t('header.text3_')}</h2>
</div>
<div>
  <button className='absolute slide-in-from-bottom bg-gray duration-300 hover:bg-green text-white text-xl h-14 py-2 px-4 rounded-full w-[10%] left-[10%]'><Link to='Contact'>{t('header.text2')}</Link></button>
  <button className='absolute slide-in-from-bottom text-gray duration-300 hover:bg-green underline rounded-full w-[10%] h-[12%] left-[24%] font-sans'><Link to='Contact'>{t('header.text3')}</Link></button>
</div>

</div>
<div className='absolute flex justify-between top-[93%] w-[70%] h-14 left-[13%]'>
...
<div>
  <div className='absolute top-[108%] left-[29%] space-y-4'>
...
<div className='absolute top-[144%] left-24 w-[25%]'>
  <div
